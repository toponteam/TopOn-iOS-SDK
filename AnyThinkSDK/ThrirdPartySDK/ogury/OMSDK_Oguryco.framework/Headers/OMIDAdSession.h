 ...
 */
@interface OMIDOgurycoAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly, nonnull) OMIDOgurycoAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(nonnull OMIDOgurycoAdSessionConfiguration *)configuration
                              adSessionContext:(nonnull OMIDOgurycoAdSessionContext *)context
