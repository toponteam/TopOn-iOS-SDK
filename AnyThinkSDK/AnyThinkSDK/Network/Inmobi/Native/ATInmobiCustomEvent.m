...
-(void)nativeDidFinishLoading:(id<ATIMNative>)native{
    ...
    NSMutableDictionary *assets = [NSMutableDictionary dictionaryWithObjectsAndKeys:self, kAdAssetsCustomEventKey, native, kAdAssetsCustomObjectKey, self.unitID, kNativeADAssetsUnitIDKey, nil];
