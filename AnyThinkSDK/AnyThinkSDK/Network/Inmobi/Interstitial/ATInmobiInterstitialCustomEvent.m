...
-(void)interstitialDidReceiveAd:(id<ATIMInterstitial>)interstitial {
    [ATLogger logMessage:@"InmobiInterstitial::interstitialDidReceiveAd:" type:ATLogTypeExternal];
}
...
-(void)interstitialDidFinishLoading:(id<ATIMInterstitial>)interstitial {
    ...
    [self trackInterstitialAdLoaded:interstitial adExtra:@{kAdAssetsPriceKey: _price ? _price : @"0", kAdAssetsBidIDKey:_bidID ? _bidID : @""}];
}
