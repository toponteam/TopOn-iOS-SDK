...
- (void)videoAdViewDidClick:(id<ATBUVideoAdView>)videoAdView {
    [ATLogger logMessage:@"TTNative::videoAdViewDidClick:" type:ATLogTypeExternal];
    [self trackNativeAdClick];
}

- (void)videoAdViewFinishViewDidClick:(id<ATBUVideoAdView>)videoAdView {
    [ATLogger logMessage:@"TTNative::videoAdViewFinishViewDidClick:" type:ATLogTypeExternal];
}

- (void)videoAdViewDidCloseOtherController:(id<ATBUVideoAdView>)videoAdView interactionType:(NSInteger)interactionType {
    [ATLogger logMessage:@"TTNative::videoAdViewDidCloseOtherController:interactionType:" type:ATLogTypeExternal];
}
