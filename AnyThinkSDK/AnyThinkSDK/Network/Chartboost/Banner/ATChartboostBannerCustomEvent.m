...
- (void)didCacheAd:(id<ATCHBCacheEvent>)event error:(id<ATCHBError>)error {
    [ATLogger logMessage:[NSString stringWithFormat:@"ChartboostBanner::didCacheAd:error:%@", error == nil ? @"" : @{
...
- (void)didShowAd:(id)event error:(id<ATCHBError>)error {
    [ATLogger logMessage:[NSString stringWithFormat:@"ChartboostBanner::didShowAd:error:%@", @(error.code)] type:ATLogTypeExternal];
