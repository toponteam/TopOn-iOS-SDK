...
@property(nonatomic, readonly) NSMutableDictionary<NSString*, ATHeliumRewardedVideoCustomEvent *> *showingCustomEventStorage;
...
-(instancetype) init {
    ...
    if (self != nil) {
        ...
        _showingCustomEventStorage = [NSMutableDictionary<NSString*, ATHeliumRewardedVideoCustomEvent*> dictionary];
...
-(void) setHeliumShowingCustomEvent:(ATHeliumRewardedVideoCustomEvent *)customEvent placementName:(NSString*)placementName {
...
-(ATHeliumRewardedVideoCustomEvent *) getHeliumShowingCustomEventWithPlacementName:(NSString*)placementName {
    __weak typeof(self) weakSelf = self;
...
- (void)heliumDidStartWithError:(id<HeliumError>)error  {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:kATHeliumInitNotification object:error != nil ? @{@"key_error":error} : @{}];
}
...
//    NSMutableDictionary* cacheDictionary = [self getHeliumRewardedVideoAdWithPlacementName:placementName];
//    ATHeliumRewardedVideoCustomEvent* customevent = cacheDictionary[@"at_customevent"];
    ATHeliumRewardedVideoCustomEvent* customevent = [self getHeliumShowingCustomEventWithPlacementName:placementName];
    if (error == nil) {
...
+(void) showRewardedVideo:(ATRewardedVideo*)rewardedVideo inViewController:(UIViewController*)viewController delegate:(id<ATRewardedVideoDelegate>)delegate {
    ...
    [[ATHeliumRewardedVideoSharedDelegate sharedDelegate] setHeliumShowingCustomEvent:(ATHeliumRewardedVideoCustomEvent *)rewardedVideo.customEvent placementName:rewardedVideo.unitID];
    ...
    if (![[ATAPI sharedInstance] initFlagForNetwork:kNetworkNameHelium]) {
        ...
        if(cacheDictionary != nil){
            ...
            if([_customEvent.rewardedAd readyToShow]){
                [_customEvent trackRewardedVideoAdLoaded:_customEvent.rewardedAd adExtra:@{kAdAssetsPriceKey:bidInfo.price, kAdAssetsBidIDKey:bidInfo.bidId}];
                cacheDictionary[@"at_is_loaded"] = @YES;
            } else {
