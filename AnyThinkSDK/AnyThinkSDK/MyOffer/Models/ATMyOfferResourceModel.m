...
@interface ATMyOfferResourceModel()
@property(nonatomic, readonly) NSMutableDictionary *resourcePaths;
@end
@implementation ATMyOfferResourceModel
/*
...
-(instancetype) initWithDictionary:(NSDictionary *)dictionary {
    ...
    if (self != nil) {
        ...
        [resourcePaths enumerateKeysAndObjectsUsingBlock:^(id  _Nonnull key, id  _Nonnull obj, BOOL * _Nonnull stop) {
            if ([obj isKindOfClass:[NSString class]]) { self->_resourcePaths[key] = [[ATMyOfferResourceLoader resourceRootPath] stringByAppendingPathComponent:[obj lastPathComponent]]; }
        }];
